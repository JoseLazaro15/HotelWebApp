...
namespace PracticaV1.Controllers
{
    public class cHabitacionsController : Controller
    {
        ...
        public cHabitacionsController(HotelJLLRContext context)
        {
            _context = context;
        }
        ...
        {
            ViewBag.TipoHabitacion = new SelectList(_context.tTipoHabitacion, "idTipo", "nombre");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("idHabitacion,numero,estado,costo,descripcion,fkTipo")] cHabitacion cHabitacion)
        {
            ...
            ViewBag.TipoHabitacion = new SelectList(_context.tTipoHabitacion, "idTipo", "nombre", cHabitacion.fkTipo); //Toma el valor de la lsita y la manda a la vista
            return View(cHabitacion);
        }
